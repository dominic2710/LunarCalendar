...
{
    public class Icon: FontImageSource
    {
        public string Kind
        {
        ...
        public static readonly BindableProperty KindProperty =
            BindableProperty.Create(nameof(Kind), typeof(string), typeof(Icon),
                                    propertyChanged: (label, oldValue, newValue) =>
                                                    ((Icon)label).SetIcon((string)oldValue, (string)newValue));

        void SetIcon(string oldValue, string newValue)
        {
            this.Glyph = newValue;
        }
        ...
        public Icon()
        {
            //this.Glyph = IconType.Send;
            //this.FontFamily = "IconFontTypes";
